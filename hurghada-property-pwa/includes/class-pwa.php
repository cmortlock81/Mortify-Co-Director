...
final class HPPWA_PWA {
    ...
    private function service_worker(): void {
        ...
        $offline = home_url('/hurghada-pwa-offline/');
        $assets = [home_url('/app/'), home_url('/app/listings/'), home_url('/app/contact/'), $offline, HPPWA_URL.'assets/css/app.css', HPPWA_URL.'assets/js/app.js', HPPWA_URL.'assets/js/install.js', HPPWA_URL.'assets/icons/icon.svg', HPPWA_URL.'assets/icons/maskable.svg'];
        ?>
...
<?php }
    private function offline(): void {
        ...
        ?>
<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Offline</title><link rel="stylesheet" href="<?php echo esc_url(HPPWA_URL . 'assets/css/app.css'); ?>"></head><body class="hppwa-app-route"><main class="hppwa-shell"><?php include HPPWA_DIR . 'templates/offline.php'; ?></main></body></html>
<?php
    }
}
